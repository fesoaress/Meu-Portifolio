  ...
  public arrayExperiencias = signal<IExperiencias[]>([
    ...
    
    {
      summary: {
        ...
        p: 'Produtividades em Equipes de Engenharia de Software | agosto 2024 - fevereiro 2025',
      },
